...
"A",               "Z",               "E",               "R",               "T",               "Y",               "U",               "I",               "O",               "P",               \
U_MT("Q", "Ctrl"), U_MT("S", "Alt"),  U_MT("D", "Meta"), U_MT("F", "Shift"),"G",               "H",               U_MT("J", "Shift"),U_MT("K", "Meta"), U_MT("L", "Alt"),  U_MT("M", "Ctrl"), \
...
"Q",               "H",               "O",               "U",               "X",               "G",               "C",               "R",               "F",               "Z",               \
U_MT("Y", "Ctrl"), U_MT("I", "Alt"),  U_MT("E", "Meta"), U_MT("A", "Shift"),U_S(">", "."),     "D",               U_MT("S", "Shift"),U_MT("T", "Meta"), U_MT("N", "Alt"),  U_MT("B", "Ctrl"), \
...
U_MT("A", "Ctrl"), U_MT("R", "Alt"),  U_MT("S", "Meta"), U_MT("T", "Shift"),"D",               "H",               U_MT("N", "Shift"),U_MT("E", "Meta"), U_MT("I", "Alt"),  U_MT("O", "Ctrl"), \
...
U_MT("A", "Ctrl"), U_MT("R", "Alt"),  U_MT("S", "Meta"), U_MT("T", "Shift"),"G",               "M",               U_MT("N", "Shift"),U_MT("E", "Meta"), U_MT("I", "Alt"),  U_MT("O", "Ctrl"), \
...
"Q",               "W",               "F",               "P",               "B",               "J",               "L",               "U",               "Y",               U_S("\"", "'"),    \
U_MT("A", "Ctrl"), U_MT("R", "Alt"),  U_MT("S", "Meta"), U_MT("T", "Shift"),"G",               "K",               U_MT("N", "Shift"),U_MT("E", "Meta"), U_MT("I", "Alt"),  U_MT("O", "Ctrl"), \
...
U_MT("A", "Ctrl"), U_MT("O", "Alt"),  U_MT("E", "Meta"), U_MT("U", "Shift"),"I",               "D",               U_MT("H", "Shift"),U_MT("T", "Meta"), U_MT("N", "Alt"),  U_MT("S", "Ctrl"), \
...
U_MT("S", "Ctrl"), U_MT("H", "Alt"),  U_MT("N", "Meta"), U_MT("T", "Shift"),U_S("<", "S_COMM"),U_S(">", "."),     U_MT("A", "Shift"),U_MT("E", "Meta"), U_MT("O", "Alt"),  U_MT("I", "Ctrl"), \
...
U_MT("A", "Ctrl"), U_MT("S", "Alt"),  U_MT("H", "Meta"), U_MT("T", "Shift"),"G",               "Y",               U_MT("N", "Shift"),U_MT("E", "Meta"), U_MT("O", "Alt"),  U_MT("I", "Ctrl"), \
U_LT("Z", U_BUTTON),U_MT("X", "AltGr"),"M",               "C",               "V",               "K",               "L",               U_S("<", "S_COMM"),U_SMT(">", ".", "AltGr"),U_SLT("?", "/", U_BUTTON),\
U_NP,              U_NP,              U_LT("Delete", U_FUN),U_LT("Back Space", U_NUM),U_LT("Enter", U_SYM),U_LT("Tab", U_MOUSE),U_LT("Space", U_NAV),U_LT("Esc", U_MEDIA),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_QWERTY_FLIP \
"Q",               "W",               "E",               "R",               "T",               "Y",               "U",               "I",               "O",               "P",               \
U_MT("A", "Ctrl"), U_MT("S", "Alt"),  U_MT("D", "Meta"), U_MT("F", "Shift"),"G",               "H",               U_MT("J", "Shift"),U_MT("K", "Meta"), U_MT("L", "Alt"),  U_SMT("\"", "'", "Ctrl"),\
...
"Page Down",       "Left",            "Down",            "Right",           U_S("Lock", "Caps Word"),U_NA,              "Shift",           "Meta",            "Alt",             "Ctrl",            \
...
"Left",            "Down",            "Up",              "Right",           U_S("Lock", "Caps Word"),U_NA,              "Shift",           "Meta",            "Alt",             "Ctrl",            \
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_NA,              U_DF(U_NAV),       U_DF(U_NUM),       "AltGr",           U_NA,              \
U_NP,              U_NP,              "Delete",          "Back Space",      "Enter",           U_NA,              U_HELD(U_NA),      U_NA,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_NAV_INVERTEDT \
U_BOOT,            U_DF(U_TAP),       U_DF(U_EXTRA),     U_DF(U_BASE),      U_NA,              "Insert",          "Home",            "Up",              "End",             "Page Up",         \
"Ctrl",            "Alt",             "Meta",            "Shift",           U_NA,              U_S("Lock", "Caps Word"),"Left",            "Down",            "Right",           "Page Down",       \
...
"Ctrl",            "Alt",             "Meta",            "Shift",           U_NA,              "Left",            "Down",            "Up",              "Right",           U_S("Lock", "Caps Word"),\
U_NA,              "AltGr",           U_DF(U_NUM),       U_DF(U_NAV),       U_NA,              "Home",            "Page Down",       "Page Up",         "End",             "Insert",          \
U_NP,              U_NP,              U_NA,              U_HELD(U_NA),      U_NA,              "Enter",           "Back Space",      "Delete",          U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_NAV \
U_BOOT,            U_DF(U_TAP),       U_DF(U_EXTRA),     U_DF(U_BASE),      U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
"Ctrl",            "Alt",             "Meta",            "Shift",           U_NA,              U_S("Lock", "Caps Word"),"Left",            "Down",            "Up",              "Right",           \
...
"Scroll Down",     "Mouse Left",      "Mouse Down",      "Mouse Right",     U_NU,              U_NA,              "Shift",           "Meta",            "Alt",             "Ctrl",            \
...
"Mouse Left",      "Mouse Down",      "Mouse Up",        "Mouse Right",     U_NU,              U_NA,              "Shift",           "Meta",            "Alt",             "Ctrl",            \
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_NA,              U_DF(U_MOUSE),     U_DF(U_SYM),       "AltGr",           U_NA,              \
U_NP,              U_NP,              "Middle Button",   "Left Button",     "Right Button",    U_HELD(U_NA),      U_NA,              U_NA,              U_NP,              U_NP
...
"Ctrl",            "Alt",             "Meta",            "Shift",           U_NA,              U_NU,              "Mouse Left",      "Mouse Down",      "Mouse Right",     "Scroll Down",     \
...
U_BOOT,            U_DF(U_TAP),       U_DF(U_EXTRA),     U_DF(U_BASE),      U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
"Ctrl",            "Alt",             "Meta",            "Shift",           U_NA,              "Mouse Left",      "Mouse Down",      "Mouse Up",        "Mouse Right",     U_NU,              \
U_NA,              "AltGr",           U_DF(U_SYM),       U_DF(U_MOUSE),     U_NA,              "Scroll Left",     "Scroll Down",     "Scroll Up",       "Scroll Right",    U_NU,              \
U_NP,              U_NP,              U_NA,              U_NA,              U_HELD(U_NA),      "Right Button",    "Left Button",     "Middle Button",   U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_MOUSE \
U_BOOT,            U_DF(U_TAP),       U_DF(U_EXTRA),     U_DF(U_BASE),      U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
"Ctrl",            "Alt",             "Meta",            "Shift",           U_NA,              U_NU,              "Mouse Left",      "Mouse Down",      "Mouse Up",        "Mouse Right",     \
...
U_S("Mode  -", "RGB Mode  +"),"Prev",            "Volume Down",     "Next",            U_S("Off", "EP Toggle"),U_NA,              "Shift",           "Meta",            "Alt",             "Ctrl",            \
...
"Prev",            "Volume Down",     "Volume Up",       "Next",            U_S("Off", "EP Toggle"),U_NA,              "Shift",           "Meta",            "Alt",             "Ctrl",            \
U_S("Clear", "BT  0 Select"),U_S("Clear", "BT  1 Select"),U_S("Clear", "BT  2 Select"),U_S("Clear", "BT  3 Select"),U_S("USB", "Out Toggle"),U_NA,              U_DF(U_MEDIA),     U_DF(U_FUN),       "AltGr",           U_NA,              \
U_NP,              U_NP,              "Mute",            "Play Pause",      "Stop",            U_NA,              U_NA,              U_HELD(U_NA),      U_NP,              U_NP
...
"Ctrl",            "Alt",             "Meta",            "Shift",           U_NA,              U_S("Off", "EP Toggle"),"Prev",            "Volume Down",     "Next",            U_S("Value  -", "RGB Value  +"),\
...
"Ctrl",            "Alt",             "Meta",            "Shift",           U_NA,              "Prev",            "Volume Down",     "Volume Up",       "Next",            U_S("Off", "EP Toggle"),\
...
"Ctrl",            "Alt",             "Meta",            "Shift",           U_NA,              U_S("Off", "EP Toggle"),"Prev",            "Volume Down",     "Volume Up",       "Next",            \
U_NA,              "AltGr",           U_DF(U_FUN),       U_DF(U_MEDIA),     U_NA,              U_S("USB", "Out Toggle"),U_S("Clear", "BT  0 Select"),U_S("Clear", "BT  1 Select"),U_S("Clear", "BT  2 Select"),U_S("Clear", "BT  3 Select"),\
U_NP,              U_NP,              U_HELD(U_NA),      U_NA,              U_NA,              "Stop",            "Play Pause",      "Mute",            U_NP,              U_NP
...
"Ctrl",            "Alt",             "Meta",            "Shift",           U_NA,              U_S("+", "="),     U_S("$", "4"),     U_S("%", "5"),     U_S("^", "6"),     U_S(":", ";"),     \
...
U_S(":", ";"),     U_S("$", "4"),     U_S("%", "5"),     U_S("^", "6"),     U_S("+", "="),     U_NA,              "Shift",           "Meta",            "Alt",             "Ctrl",            \
...
"Ctrl",            "Alt",             "Meta",            "Shift",           U_NA,              "Scroll Lock",     "F4",              "F5",              "F6",              "F11",             \
...
"F11",             "F4",              "F5",              "F6",              "Scroll Lock",     U_NA,              "Shift",           "Meta",            "Alt",             "Ctrl",            \
...
"Ctrl",            "Alt",             "Meta",            "Shift",           U_NU,              U_NU,              "Shift",           "Meta",            "Alt",             "Ctrl",            \
